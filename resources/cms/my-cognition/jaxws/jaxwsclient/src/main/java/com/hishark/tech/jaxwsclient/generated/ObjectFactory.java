 ...
 * generated in the com.hishark.jaxws.server package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetMessage_QNAME = new QName("http://server.jaxws.hishark.com/", "getMessage");
    private final static QName _GetMessageResponse_QNAME = new QName("http://server.jaxws.hishark.com/", "getMessageResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.hishark.jaxws.server
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.jaxws.hishark.com/", name = "getMessage")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.jaxws.hishark.com/", name = "getMessageResponse")
