...
Abstract Semantic: Sequence corresponding Impl Semantic: Cons, PersistentList, PersistentVector$ChunkedSeq, PersistentArrayMap$Seq, APersistentMap$KeySeq ...
...
Examples:
List:
  container contains 1 same type stuff & 1 another stuff
Tree:
  container contains multiple same type stuff & multiple another stuff
