    ...
    Note:
      ...
      #+BEGIN_SRC scheme
        (begin (println "1")
               ...
               (println "4"))
      #+END_SRC
      When (println "3.b") is Redex, its Continuation is: 
      #+BEGIN_SRC scheme
        (begin (begin []
                      (abort (println "3.c"))
                      (println "3.d"))
               (println "4"))
      #+END_SRC
      When `(abort (println "3.c"))` is Redex, its Continuation is: 
      #+BEGIN_SRC scheme
        (begin []
               (println "3")
               (begin (println "3.a")
...
******* Semantic can have multiple impl
E.g. 
Semantic: List have impl: Cons, PersistentList
Semantic: Sequence have impl: Cons, PersistentList, PersistentVector$ChunkedSeq, PersistentArrayMap$Seq, APersistentMap$KeySeq ...
Semantic: core.matrix/wrapper have impl: NDWrapper, PersistentVector
...
weakness:
  ...
  custodian follow implict-over-explict
