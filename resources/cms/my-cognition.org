...
Ansible
    ...
    control windows server:
      ...
      2, in host invertory: config remote server's shell: ansible_shell_type=powershell
...
module name resolve:
Main/REPL resolve to root module instance
...
root module instance only contains deps map


normal module instance loaded from project.toml
root module instance loaded from active enviroment's project.toml/source tree & merged with other roots map in LOAD_PATH
